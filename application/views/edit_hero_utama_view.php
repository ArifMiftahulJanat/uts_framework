		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="<?php echo site_url('hero/index/'.$this->uri->segment(3)); ?>">Hero Utama</a></li>
									</ul>
					...
					<?php echo form_open_multipart('hero/update/'.$this->uri->segment(3)); ?>
								...
								<a href="<?php echo site_url('jenis_hero/index/'.$this->uri->segment(3)); ?>"> <button type="button" class="btn btn-info">Cancel</button></a>
					<?php echo form_close(); ?>
					</div>
