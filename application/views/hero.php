							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										...
										<li class="active"><a href="<?php echo site_url('hero/create/'.$this->uri->segment(3)) ?>">Tambah Hero</a></li>
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($hero_list as $key) { ?>
									<tr>
										...
										<td><?php echo "<img src='http://localhost:8005/codeigniter_uts/assets/uploads/$key->foto' height='75px' width='50px'>" ?></td>
										<td>
